                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                      ...
                      <ul class="list-unstyled user_data">
                        <li>
                          <i class="fa fa-file"></i> NIK : <?php echo $user['nik'];?>
                        </li>
                        <li>
                      ...
                      <br>
                        <a href="<?php echo base_url('sys/edit_profil');?>" class="btn btn-round btn-success"><i class="fa fa-edit m-right-xs"></i>Edit Profile</a>
                        <br><br>
                        <a href="<?php echo base_url('sys/edit_password');?>" class="btn btn-round btn-primary"><i class="fa fa-edit m-right-xs"></i>Edit Password</a>
                    </div>
