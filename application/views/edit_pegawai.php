      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <div class="x_content">
              <br />
              <form action="<?php echo base_url();?>sys/update_data_pegawai" method="post" data-parsley-validate class="form-horizontal form-label-left">
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <input type="text" name="nik" value="<?php echo $row['nik'];?>" class="form-control col-md-7 col-xs-12" readonly>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <select name="hak_akses" class="form-control">
                      <option value="1" <?php if($row['hak_akses']=='1'){echo "selected";}?>>USER</option>
                      <option value="2" <?php if($row['hak_akses']=='2'){echo "selected";}?>>MANAGER</option>
                      <option value="3" <?php if($row['hak_akses']=='3'){echo "selected";}?>>ADMIN</option>
