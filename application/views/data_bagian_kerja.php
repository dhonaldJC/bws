      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <div class="x_content">
              <form id="demo-form"  action="<?php echo base_url();?>sys/submit_bagian" method="post" data-parsley-validate class="form-horizontal form-label-left">
                ...
                foreach($bagian->result_array() as $data){?>
                  <tr>
                    ...
                    <td width="100px"><center>
                      <a href="<?php echo base_url('sys/edit_bagian');?>/<?php echo $data['id_bdkerja'];?>">
                        <button class="btn btn-info btn-xs">
                          <i class="fa fa-edit"></i>
                        </button>
                      </a>
                      <a onClick="return confirmSubmit()" href="<?php echo base_url('sys/hapus_bagian');?>/<?php echo $data['id_bdkerja'];?>">
