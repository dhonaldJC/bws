                    ...
                    <table id="example1" class="table table-striped table-bordered">
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <a href="<?php echo base_url('sys/detail_masalah_solusi');?>/<?php echo $data['id_tacit'];?>"><?php echo $data['judul_tacit'];?>
                          </td>
                          <td>
                          ...
                          <td width="100px"><center>
                            <a href="<?php echo base_url('sys/edit_masalah_solusi');?>/<?php echo $data['id_tacit'];?>" title="Edit Data">
                              <button class="btn btn-info btn-xs">
                                <i class="fa fa-edit"></i>
                              </button>
                            </a>
                            <a onClick="return confirmSubmit()" href="<?php echo base_url('sys/hapus_case_solusi');?>/<?php echo $data['id_tacit'];?>" title="Hapus Data">
